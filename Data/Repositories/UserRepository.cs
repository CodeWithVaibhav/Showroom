...
using User = Showroom.Data.Entities.User;

namespace Showroom.Data.Repositories
{
    ...
    public class UserRepository : GenericRepository<User>, IUserRepository
    {
        ...
        public UserRepository(ShowroomDbContext context, ILogger<UserRepository> logger) : base(context)
        {
            this._logger = logger;
        }
