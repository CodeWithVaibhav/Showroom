...
using Showroom.Data.Repositories;
...
builder.Services.AddDbContext<ShowroomDbContext>(x => x.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnectionString")));
